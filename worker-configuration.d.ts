/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: dc59d96ef304d9b4bc69584628c2d9e1)
// Runtime types generated with workerd@1.20260405.1 2025-08-03 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
	}
	type RssReaderMetricsStreamRecord = { namespace: string; service: string; metric_name: string; metric_unit: string; metric_value: number; timestamp: string; correlation_id?: string; feedId?: string; status?: string; error?: string; userId?: string; action?: string; httpStatus?: string };
	interface Env {
		rss_reader_metrics_store: R2Bucket;
		DB: D1Database;
		METRICS_PIPELINE: import("cloudflare:pipelines").Pipeline<Cloudflare.RssReaderMetricsStreamRecord>;
